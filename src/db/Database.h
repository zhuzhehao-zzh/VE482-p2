...
public:
  ...
  void clearTable(const std::string &tableName); // TODO: new added function for TRUNCATE

  void printAllTable();

  //如果table存在返回table，否则创建table并返回
  Table &get_copied_table(const std::string &tableName);
